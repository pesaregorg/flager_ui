...
import 'package:example/screens/components/icon_theme_mode.dart';
        ...
        children: [
          ...
          Container(
            ...
            child: GridView.count(
                ...
                children: List.generate(FColors.primaries.length, (index) {
                  return InkWell(
                    onTap: () => context.read<ThemeColorProvider>().changeThemeColor(index),
                    child: Container(
                      decoration: BoxDecoration(
                        color: FColors.primaries[index],
                        borderRadius: BorderRadius.circular(4.0),
                      ),
                      child: Center(
                        child: Provider.of<ThemeColorProvider>(context).getThemeColor == FColors.primaries[index] ?
                        const Icon(Icons.done_rounded, color: FColors.white,) : const SizedBox.shrink(),
                      ),
                    ),
                  );
                })),
